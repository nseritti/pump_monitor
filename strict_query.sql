 ...
 SELECT * FROM (SELECT pump_analysis_1.coin_id, pump_analysis_1.symbol, pump_analysis_1.price_usd,
                ...
                as t WHERE t.1_volume < t.2_volume and t.2_volume < t.3_volume and t.3_volume < t.4_volume and t.4_volume < t.5_volume and t.5_volume < t.6_volume and t.last_change > 1 ;
